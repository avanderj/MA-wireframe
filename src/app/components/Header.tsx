        ...
        >
          ...
          <div className="px-4 pb-4">
            <div className="space-y-2">
              <button
                onClick={() => onViewChange("my-apps")}
                className={`w-full px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2 ${
                  activeView === "my-apps"
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-6 flex-1">
            ...
            >
              <button
                onClick={() => onViewChange("my-apps")}
                className={`px-4 py-2.5 rounded-xl transition-all duration-200 flex items-center gap-2.5 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2 ${
                  activeView === "my-apps"
                    ? "bg-gradient-to-r from-[#052049] to-[#18A1CD] text-white shadow-lg shadow-[#052049]/20"
                    : "text-gray-700 hover:bg-gray-50/80 hover:text-[#052049]"
                }`}
