...
export function Header({
    ...
    if (navLayout === "sidebar") {
        return (
            <>
                {/* Mobile: keep a compact top header */}
                <header
                    role="banner"
                    className="lg:hidden bg-white backdrop-blur-xl border-b border-gray-100/60 sticky top-0 z-30"
                >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="p-2 hover:bg-gray-50/80 rounded-xl transition-all duration-200"
                                    aria-label="Search"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 hover:bg-gray-50/80 px-2 py-2 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2"
                        ...
                        {isMobileMenuOpen && (
                            <nav className="mt-4 pt-4 border-t border-gray-200 space-y-2">
                                ...
                                <button
                                    ...
                                    className={`w-full px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3 ${activeView === "app-library" ||
                                        activeView === "bundle-detail"
                                        ? "bg-gradient-to-r from-[#052049] to-[#18A1CD] text-white"
                                        : "text-gray-700 hover:bg-gray-50"
                                        }`}
                                >
                ...
                {/* Desktop: left dashboard sidebar */}
                <aside
                    role="navigation"
                    aria-label="Primary navigation"
                    className="hidden lg:flex flex-col w-72 bg-white border-r border-gray-200/60 sticky top-0 h-screen z-30"
                >
                    ...
                    <div className="px-4 py-4 pb-4">
                        <div className="space-y-2">
                            <button
                                onClick={() => onViewChange("my-apps")}
                                className={`w-full px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2 ${activeView === "my-apps"
                            ...
                            <button
                                ...
                                className={`w-full px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2 ${activeView === "app-library" || activeView === "bundle-detail"
                                    ? "bg-gradient-to-r from-[#052049] to-[#18A1CD] text-white shadow-lg shadow-[#052049]/20"
                                    : "text-gray-700 hover:bg-gray-50/80 hover:text-[#052049]"
                                    }`}
                                aria-current={
                            ...
                            >
                                <Library
                                    ...
                                    aria-hidden="true"
                                />
                                <span className="font-semibold text-[14px]">App Library</span>
                            </button>
                            <button
                                onClick={() => onViewChange("news")}
                                className={`w-full px-4 py-3 rounded-xl transition-all duration-200 flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2 ${activeView === "news"
                                    ? "bg-gradient-to-r from-[#052049] to-[#18A1CD] text-white shadow-lg shadow-[#052049]/20"
                                    : "text-gray-700 hover:bg-gray-50/80 hover:text-[#052049]"
                                    }`}
                            ...
                            <button
                                onClick={onSearchClick}
                                className="w-full flex items-center gap-3 bg-gray-50/50 rounded-xl px-4 py-3 border border-gray-200/60 hover:border-gray-300/80 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2"
                    ...
                    <div className="mt-auto border-t border-gray-100/60">
                        <div className="px-4 py-4">
                            <button
                                onClick={() => setIsHelpDropdownOpen(!isHelpDropdownOpen)}
                                className="w-full flex items-center justify-between px-4 py-3 hover:bg-gray-50/80 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2"
                            ...
                            {isHelpDropdownOpen && (
                                <div className="mt-2 bg-white rounded-2xl border border-gray-200/60 overflow-hidden">
                                    <div className="p-2">
                                        <a
                                            href="#"
                                            className="flex items-center gap-3 px-3 py-2.5 hover:bg-gray-50/50 rounded-xl transition-all"
                                        >
                                            <GraduationCap
                                                className="w-5 h-5 text-gray-500"
                                                strokeWidth={2}
                                        ...
                                        <a
                                            href="#"
                                            className="flex items-center gap-3 px-3 py-2.5 hover:bg-red-50 rounded-xl transition-all text-red-600"
                                        >
                                            <Flag className="w-5 h-5" strokeWidth={2} />
                                            <span className="font-semibold text-sm">
                                                Report Phishing
                        ...
                        <div className="px-4 pb-5">
                            <button
                                onClick={onProfileClick}
                                className="w-full flex items-center gap-3 hover:bg-gray-50/80 px-4 py-3 rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2"
                                aria-label="Open profile menu for Chris Garcia"
                            >
                                <div
                                    className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#052049] to-[#18A1CD] flex items-center justify-center font-bold text-[13px] shadow-lg shadow-[#052049]/20 text-black"
                                    aria-hidden="true"
                                >
                                    CG
                                </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3 md:gap-6 flex-1">
                        ...
                        >
                            ...
                            <button
                                onClick={onSearchClick}
                                className="flex items-center gap-3 bg-gray-50/50 rounded-xl px-4 py-2.5 border border-gray-200/60 hover:border-gray-300/80 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2 "
                            >
                                <Search
