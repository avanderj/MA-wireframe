...
export function FeaturedAppsSection({ apps, onGetInfo, onToggleSave }: FeaturedAppsSectionProps) {
  ...
  return (
    <div className="bg-white border-b border-gray-200/60">
      <div className="max-w-7xl mx-auto px-4 md:px-10 pt-[4px] pb-[40px] pr-[40px] pl-[40px]">
        {/* Featured Apps Grid */}
              ...
              <div className="p-5">
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500">{app.metadata.owner}</p>
                  </div>
                </div>
