          ...
          <div className="bg-gradient-to-r from-[#052049] to-[#18A1CD] text-white p-4 sm:p-8">
            ...
            <div className="flex gap-4 sm:gap-6 items-start">
              ...
              <div className="flex-1 pt-2">
                ...
                <p className="text-blue-100 text-base sm:text-lg mb-1">IT Department</p>
                <p className="text-blue-200 text-sm">Senior Systems Administrator</p>
              </div>
            </div>
          </div>
                    ...
                    {onToggleVersaAccess && (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${
                              ...
                              <Sparkles className={`w-6 h-6 transition-colors ${
                                hasVersaAccess ? 'text-white' : 'text-purple-600 group-hover:text-white'
                              }`} strokeWidth={2.5} />
                            </div>
                            <div>
                          ...
                          <div className={`w-12 h-6 rounded-full transition-all flex items-center ${
                            hasVersaAccess ? 'bg-gradient-to-r from-[#052049] to-[#18A1CD]' : 'bg-gray-300'
                          }`}>
                            <div className={`w-5 h-5 bg-white rounded-full shadow-md transition-transform ${
                              hasVersaAccess ? 'translate-x-6' : 'translate-x-1'
                            }`}></div>
                          </div>
                        </div>
                      </button>
                    ...
                    {onAdminLogin && (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${
                              ...
                              <Lock className={`w-6 h-6 transition-colors ${
                                isAdmin ? 'text-white' : 'text-purple-600 group-hover:text-white'
                              }`} strokeWidth={2.5} />
                            </div>
                            <div>
                              <div className="font-bold text-[#052049] flex items-center gap-2">
                          ...
                          <div className={`w-12 h-6 rounded-full transition-all flex items-center ${
                            isAdmin ? 'bg-gradient-to-r from-[#052049] to-[#18A1CD]' : 'bg-gray-300'
                          }`}>
                            <div className={`w-5 h-5 bg-white rounded-full shadow-md transition-transform ${
