  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed right-0 top-0 h-full w-full sm:max-w-2xl bg-gradient-to-br from-white to-gray-50 shadow-2xl z-50 transform transition-transform duration-300 ease-out ${
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="bg-gradient-to-r from-[#052049] to-[#18A1CD] text-black p-4 sm:p-8">
            ...
            <div className="flex gap-4 sm:gap-6 items-start">
              <div
                className="w-20 h-20 sm:w-24 sm:h-24 flex-shrink-0 rounded-2xl border border-gray-200 bg-gradient-to-br from-teal-400 to-cyan-500 flex items-center justify-center shadow-2xl font-bold text-3xl sm:text-4xl"
                aria-hidden="true"
              >
                CG
              </div>
              <div className="flex-1 pt-2">
                ...
                <p className="text-black text-base sm:text-lg mb-1">
                  IT Department
                </p>
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-8" ref={contentRef}>
            <div className="space-y-8">
                ...
                <div className="bg-white rounded-2xl p-6 border border-blue-100 space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-1">
                      ...
                      <div className="font-semibold text-gray-900">
                        Information Technology Services (502341)
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-1">
                      <div className="text-sm text-gray-500 mb-1">
                        Edu Person Principal Name (ePPN)
                      </div>
                      <div className="font-semibold text-gray-900">
                        847392@ucsf.edu
                      </div>
                ...
                <div className="space-y-3">
                  ...
                  {idTab === "campus" && (
                    <>
                      ...
                      <button
                        className="w-full bg-white rounded-xl p-5 border-2 border-red-200/60 bg-gradient-to-br from-red-50/30 to-orange-50/30 text-left group"
                        aria-label="Update password - Overdue"
                      >
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <div className="text-sm text-gray-700">
                                  Your password has expired and needs to be
                                  updated
                                </div>
                              </div>
                            </div>
                            <ExternalLink
                              className="w-5 h-5 text-red-600 transition-colors"
                              aria-hidden="true"
                            />
                          </div>
                  ...
                  {idTab === "health" && (
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
                      <p className="text-gray-500 text-center">
                        No health system account details available
                      </p>
                    </div>
                  )}
                </div>
              ...
              {/* Demo Tools */}
              {(onToggleVersaAccess || onToggleSidebarNav || onAdminLogin) && (
                <div>
                  <h3 className="text-xl font-semibold mb-5 text-[#052049] flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    ...
                    {onToggleVersaAccess && (
                      <button
                        ...
                        className={`w-full rounded-xl p-5 border-2 transition-all text-left group focus:outline-none focus:ring-2 focus:ring-[#18A1CD] focus:ring-offset-2 ${
                          hasVersaAccess
                        ...
                        aria-label={
                          hasVersaAccess
                            ? "Disable Versa AI Assistant"
                            : "Enable Versa AI Assistant"
                        }
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                          ...
                          <div
                            className={`w-12 h-6 rounded-full transition-all flex items-center ${
                              hasVersaAccess
                                ? "bg-gradient-to-r from-[#052049] to-[#18A1CD]"
                                : "bg-gray-300"
                            }`}
                          >
                            <div
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600">
                                {hasSidebarNav
                                  ? "Left dashboard nav enabled"
                                  : "Switch header to left dashboard nav"}
                              </div>
                            </div>
                          </div>
                          <div
          ...
          <div className="border-t bg-white p-6">
            <div className="flex gap-4">
              ...
              <button
                className="flex-1 px-6 py-4 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white rounded-xl transition-all shadow-lg font-semibold focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2"
                aria-label="Sign out of UCSF Connect"
              >
                Sign Out
              </button>
            </div>
