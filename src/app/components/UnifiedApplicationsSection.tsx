      ...
      <div>
        ...
        <div className="mb-8">
          <div className="w-full overflow-x-auto">
            <div className="inline-flex min-w-max bg-white rounded-2xl p-1.5 border-2 border-gray-200 gap-2">
              <button
                onClick={() => onViewModeChange("saved")}
                className={`px-4 sm:px-8 py-3.5 rounded-xl font-bold transition-all flex items-center gap-2 whitespace-nowrap ${
                  viewMode === "saved"
        ...
        {viewMode === "all" && (
          <div className="mb-6">
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <div className="w-full overflow-x-auto">
                <div className="inline-flex min-w-max bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-1.5 gap-1.5 border-2 border-gray-200 shadow-sm">
                  <button
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-semibold rounded-full border-2 transition-all whitespace-nowrap flex items-center gap-2 ${
                    isActive
          ...
          <div>
            <div className="mb-6 flex items-center gap-3">
              <div className="p-3 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl">
                <Boxes className="w-6 h-6 text-indigo-600" strokeWidth={2.5} />
              </div>
              <div>
